...
class RelationControl extends _react.default.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "loadOptions", (0, _debounce2.default)((term, callback) => {
      ...
      let searchFieldsArray = _immutable.List.isList(searchFields) ? searchFields.toJS() : [searchFields];
      const file = field.get('file'); // if the field has a previous value perform the initial search based on the value field
